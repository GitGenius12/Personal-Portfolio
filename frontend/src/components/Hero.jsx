  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto py-16 sm:py-32">
        ...
        {/* Role */}
        <p className="text-gray-500 text-sm sm:text-base uppercase tracking-widest mb-3 sm:mb-4 font-medium">
          Software Engineer
        </p>

        {/* Tagline */}
        <p className="text-gray-300 text-lg sm:text-xl md:text-2xl font-light leading-relaxed max-w-4xl mb-8 sm:mb-10">
          {personalInfo.tagline}
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-14 w-full sm:w-auto">
          <button
            onClick={() => scrollToSection('projects')}
            className="w-full sm:w-auto px-7 py-3.5 rounded-lg font-semibold text-base text-black bg-white hover:bg-gray-200 transition-all duration-200 hover:opacity-90 active:scale-95"
          >
            View Projects
          </button>
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-3.5 rounded-lg font-medium text-base text-gray-300 hover:text-white transition-colors duration-200 border border-white/10 hover:border-white/25"
          >
            Get in Touch
          </button>
        ...
        >
          <svg className="w-6 h-6 sm:w-7 sm:h-7 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
